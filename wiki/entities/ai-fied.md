...
Criador de conteúdo focado em ferramentas e aplicações práticas de IA. Opera sob o handle @ai.fiedstudio no Instagram. Publica carousels com prompts prontos para aplicar filosofias de empreendedorismo e riqueza (Naval Ravikant, Dan Koe, Alex Hormozi) via Claude.

## Estilo de conteúdo

- Carousels com prompts completos em estrutura ROLE/TASK/STEPS/RULES/OUTPUT
- Mix de slides em inglês e PT-BR (indica adaptação para audiência brasileira)
- Gancho via "secret modes" e recursos supostamente ocultos do Claude (marketing hook)
